node{
   ...
   stage('SonarQube analysis code Quality') {
    ...
    stage('publish to Nexus'){
       nexusPublisher nexusInstanceId: 'nexusrep', nexusRepositoryId: 'maven-releases', packages: [[$class: 'MavenPackage', mavenAssetList: [[classifier: '', extension: '', filePath: 'Simple Maven examplen  Sonar-2.0.jar']], mavenCoordinate: [artifactId: 'gestion', groupId: 'org.ali', packaging: 'jar', version: '2.0']]]
    }
   stage('notification'){
